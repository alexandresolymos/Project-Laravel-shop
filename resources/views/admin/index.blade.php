        ...
        <div class="content-header">
            ...
            <div class="content-header-block">
                <a href="{{ route('admin.product.index') }}">
                    <svg class="fa" width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span>Produits</span>
                    <span class="header-block-number">78</span>
                </a>
            </div>
            ...
            <div class="content-header-block">
                <a href="#">
                    ...
                    <span>Commandes</span>
                    <span class="header-block-number">132</span>
                </a>
            </div>
