...
@section('content')
    ...
    <div class="add">
        <a href="{{route('admin.category.create')}}" class="btn-grad">Ajouter une catégorie</a>
                    ...
                    <div class="col-12-m col-6">
                        <div class="card">
                            ...
                            <div class="card-half card-description">
                                <h1 class="card-title">#{{ $categorys->id }} - {{ $categorys->title }}</h1>
                                <div class="card-actions">
                                    <a class="btn-grad-product" href="{{ route('admin.category.edit', $categorys->id) }}">
                                    ...
                                    <form method="POST" action="{{ route('admin.category.delete', $categorys->id) }}">
                                        @csrf
                                        @method("DELETE")
